...
/****** Object:  StoredProcedure [dbo].[DeleteTempAssessmentTable]    Script Date: 15/08/2014 13:56:31 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Delete assessment table from temp assessment table
-- =============================================
CREATE PROCEDURE [dbo].[DeleteTempAssessmentTable]
